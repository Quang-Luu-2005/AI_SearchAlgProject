...
export const translations = {
  en: {
    ...
    alg_compare: 'Compare UCS & A* (2 Points)',
    ...
    toggle_3d_title: 'Switch to 3D isometric view (Pitch 52°)',
    ...
    tooltip_3d: 'Switch to 3D isometric view (Pitch 52°)',
  ...
  vi: {
    ...
    alg_compare: 'So sánh UCS và A* (2 điểm)',
    ...
    recenter_map: 'Đưa bản đồ về toàn vùng Thủ Đức',
    reset_view: 'Đưa bản đồ về toàn vùng Thủ Đức',
    view_2d: '🗺️ 2D View',
    view_3d: '🏙️ 3D On',
    toggle_2d_title: 'Chuyển về góc nhìn phẳng 2D',
    toggle_3d_title: 'Chuyển sang góc nhìn nghiêng 3D (Pitch 52°)',
    toggle_2d_aria: 'Góc nhìn 2D',
    toggle_3d_aria: 'Góc nhìn 3D',
    toggle_2d_label: '🗺️ 2D View',
    toggle_3d_label: '🏙️ 3D On',
    tooltip_2d: 'Chuyển về góc nhìn phẳng 2D',
    tooltip_3d: 'Chuyển sang góc nhìn nghiêng 3D (Pitch 52°)',
    map_data_status: 'node · edge',

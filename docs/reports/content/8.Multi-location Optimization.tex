...
Nhóm em chạy benchmark trên bản đồ \texttt{thu\_duc\_landmarks\_v1.0.4} với 10 cặp OD, một baseline scenario, 6 thuật toán và 20 lần lặp cho mỗi trường hợp. Tổng cộng có 1,200 lượt chạy được đo. Các bảng và số liệu trong phần này được lấy từ file kết quả JSON sau khi chạy benchmark.
...
Để giải thích route rõ hơn, nhóm em không chỉ báo cáo path cuối cùng mà còn tách tổng cost theo từng cạnh. Hai ví dụ dưới đây dùng fixture \texttt{toy\_graph\_v0.1}; toàn bộ traffic và flood trong fixture đều mang nhãn \texttt{SIMULATED}. Số liệu được sinh bởi benchmark \texttt{ROUTE\_EXPLANATIONS\_V1}, sau đó đối chiếu lại với cost engine. Trên giao diện landmark, khi scenario có cản trở, hệ thống dùng cùng thuật toán đang chọn để sinh tối đa hai tuyến thay thế và hiển thị distance, ETA, total cost cho từng tuyến. Tuyến được chọn là tuyến có composite cost thấp nhất; khi các tuyến có cost gần nhau, khoảng cách là tiêu chí ưu tiên trong phần giải thích.

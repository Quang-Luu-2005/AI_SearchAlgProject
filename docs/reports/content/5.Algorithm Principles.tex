...
{\scriptsize
\begin{tabularx}{\textwidth}{>{\raggedright\arraybackslash}p{2.0cm} >{\raggedright\arraybackslash}X >{\raggedright\arraybackslash}p{1.45cm} >{\raggedright\arraybackslash}p{1.35cm} >{\raggedright\arraybackslash}p{1.25cm} >{\raggedright\arraybackslash}p{1.25cm}}
\toprule
...
\begin{itemize}
\item (*) Đầy đủ trên graph hữu hạn khi cách cài đặt có kiểm tra trạng thái đã thăm và không bị nhánh vô hạn.
\item (**) A* tối ưu trong report vì dùng lower-bound heuristic của Chương 6; dùng heuristic tùy ý thì không còn kết luận này.
\item (***) Bidirectional tối ưu khi hai hướng dùng cost tương thích và điều kiện dừng được chứng minh đúng.
\end{itemize}

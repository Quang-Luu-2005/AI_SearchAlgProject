...
Scenario được giữ cố định trong một lần tìm kiếm nên cost edge và \(\rho_s\) không thay đổi giữa các bước mở rộng node. Khi traffic, flood hoặc weight thay đổi, cần tính lại \(\rho_s\). Heuristic này được thiết kế cho composite cost đang chọn, không phải để tối ưu riêng khoảng cách hoặc thời gian.

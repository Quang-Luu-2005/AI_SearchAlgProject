...
- Giữ viewport ở min zoom 12, tắt world-copy và bỏ hard `maxBounds`. Initial/reset fit
  context ring động ngoài graph để cạnh sát biên không bị che; endpoint đơn dùng zoom 16.5.

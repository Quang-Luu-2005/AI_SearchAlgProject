# FloodRoute HCMC — dataset nộp bài v1.0.0
...
- `scenarios.json`: scenario baseline với tham số gắn nhãn `ASSUMPTION`.
...
thuật, không dùng làm hướng dẫn điều hướng hoặc an toàn thực tế.
